...
> models::ApiPeriodV2010PeriodAccountPeriodUsagePeriodUsageTrigger create_usage_trigger(account_sid, callback_url, trigger_value, usage_category, callback_method, friendly_name, recurring, trigger_by)
...
**usage_category** | **models::UsageTriggerEnumUsageCategory** |  | [required] |
...
**recurring** | Option<**models::UsageTriggerEnumRecurring**> |  |  |
**trigger_by** | Option<**models::UsageTriggerEnumTriggerField**> |  |  |

### Return type

[**models::ApiPeriodV2010PeriodAccountPeriodUsagePeriodUsageTrigger**](api.v2010.account.usage.usage_trigger.md)
...
> models::ApiPeriodV2010PeriodAccountPeriodUsagePeriodUsageTrigger fetch_usage_trigger(account_sid, sid)
...
> models::ApiPeriodV2010PeriodAccountPeriodUsagePeriodUsageTrigger update_usage_trigger(account_sid, sid, callback_method, callback_url, friendly_name)
