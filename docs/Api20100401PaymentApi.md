...
> models::ApiPeriodV2010PeriodAccountPeriodCallPeriodPayments create_payments(account_sid, call_sid, idempotency_key, status_callback, bank_account_type, charge_amount, currency, description, input, min_postal_code_length, parameter, payment_connector, payment_method, postal_code, security_code, timeout, token_type, valid_card_types)
...
**bank_account_type** | Option<**models::PaymentsEnumBankAccountType**> |  |  |
...
**payment_method** | Option<**models::PaymentsEnumPaymentMethod**> |  |  |
...
**token_type** | Option<**models::PaymentsEnumTokenType**> |  |  |
...
[**models::ApiPeriodV2010PeriodAccountPeriodCallPeriodPayments**](api.v2010.account.call.payments.md)
...
> models::ApiPeriodV2010PeriodAccountPeriodCallPeriodPayments update_payments(account_sid, call_sid, sid, idempotency_key, status_callback, capture, status)
...
**capture** | Option<**models::PaymentsEnumCapture**> |  |  |
**status** | Option<**models::PaymentsEnumStatus**> |  |  |
