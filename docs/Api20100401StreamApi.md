...
**track** | Option<**models::StreamEnumTrack**> |  |  |
...
[**models::ApiPeriodV2010PeriodAccountPeriodCallPeriodStream**](api.v2010.account.call.stream.md)
...
> models::ApiPeriodV2010PeriodAccountPeriodCallPeriodStream update_stream(account_sid, call_sid, sid, status)
...
**status** | **models::StreamEnumUpdateStatus** |  | [required] |
