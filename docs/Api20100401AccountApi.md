...
> models::ApiPeriodV2010PeriodAccount create_account(friendly_name)
...
[**models::ApiPeriodV2010PeriodAccount**](api.v2010.account.md)
...
> models::ApiPeriodV2010PeriodAccount fetch_account(sid)
...
> models::ApiPeriodV2010PeriodAccount update_account(sid, friendly_name, status)
...
**status** | Option<**models::AccountEnumStatus**> |  |  |
