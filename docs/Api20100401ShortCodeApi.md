...
> models::ApiPeriodV2010PeriodAccountPeriodShortCode fetch_short_code(account_sid, sid)
...
[**models::ApiPeriodV2010PeriodAccountPeriodShortCode**](api.v2010.account.short_code.md)
...
> models::ApiPeriodV2010PeriodAccountPeriodShortCode update_short_code(account_sid, sid, friendly_name, api_version, sms_url, sms_method, sms_fallback_url, sms_fallback_method)
