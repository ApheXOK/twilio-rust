...
> models::ApiPeriodV2010PeriodAccountPeriodKey fetch_key(account_sid, sid)
...
[**models::ApiPeriodV2010PeriodAccountPeriodKey**](api.v2010.account.key.md)
...
> models::ApiPeriodV2010PeriodAccountPeriodKey update_key(account_sid, sid, friendly_name)
