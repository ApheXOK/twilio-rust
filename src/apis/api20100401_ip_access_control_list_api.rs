...
pub async fn create_sip_ip_access_control_list(configuration: &configuration::Configuration, params: CreateSipIpAccessControlListParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipIpAccessControlList, Error<CreateSipIpAccessControlListError>> {
...
pub async fn fetch_sip_ip_access_control_list(configuration: &configuration::Configuration, params: FetchSipIpAccessControlListParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipIpAccessControlList, Error<FetchSipIpAccessControlListError>> {
    let local_var_configuration = configuration;
...
pub async fn update_sip_ip_access_control_list(configuration: &configuration::Configuration, params: UpdateSipIpAccessControlListParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipIpAccessControlList, Error<UpdateSipIpAccessControlListError>> {
    let local_var_configuration = configuration;
