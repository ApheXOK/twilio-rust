...
pub async fn create_token(configuration: &configuration::Configuration, params: CreateTokenParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodToken, Error<CreateTokenError>> {
