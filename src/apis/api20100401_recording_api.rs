...
pub async fn create_call_recording(configuration: &configuration::Configuration, params: CreateCallRecordingParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodCallPeriodCallRecording, Error<CreateCallRecordingError>> {
...
pub async fn fetch_call_recording(configuration: &configuration::Configuration, params: FetchCallRecordingParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodCallPeriodCallRecording, Error<FetchCallRecordingError>> {
    let local_var_configuration = configuration;
...
/// Fetch an instance of a recording for a call
pub async fn fetch_conference_recording(configuration: &configuration::Configuration, params: FetchConferenceRecordingParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodConferencePeriodConferenceRecording, Error<FetchConferenceRecordingError>> {
    let local_var_configuration = configuration;
...
pub async fn fetch_recording(configuration: &configuration::Configuration, params: FetchRecordingParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodRecording, Error<FetchRecordingError>> {
    let local_var_configuration = configuration;
...
pub async fn list_recording(configuration: &configuration::Configuration, params: ListRecordingParams) -> Result<models::ListRecordingResponse, Error<ListRecordingError>> {
    let local_var_configuration = configuration;
...
pub async fn update_call_recording(configuration: &configuration::Configuration, params: UpdateCallRecordingParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodCallPeriodCallRecording, Error<UpdateCallRecordingError>> {
    let local_var_configuration = configuration;
...
pub async fn update_conference_recording(configuration: &configuration::Configuration, params: UpdateConferenceRecordingParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodConferencePeriodConferenceRecording, Error<UpdateConferenceRecordingError>> {
    let local_var_configuration = configuration;
