...
pub async fn create_sip_ip_access_control_list_mapping(configuration: &configuration::Configuration, params: CreateSipIpAccessControlListMappingParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipIpAccessControlListMapping, Error<CreateSipIpAccessControlListMappingError>> {
...
pub async fn fetch_sip_ip_access_control_list_mapping(configuration: &configuration::Configuration, params: FetchSipIpAccessControlListMappingParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipIpAccessControlListMapping, Error<FetchSipIpAccessControlListMappingError>> {
    let local_var_configuration = configuration;
