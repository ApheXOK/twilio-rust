...
pub async fn create_incoming_phone_number(configuration: &configuration::Configuration, params: CreateIncomingPhoneNumberParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodIncomingPhoneNumber, Error<CreateIncomingPhoneNumberError>> {
...
pub async fn fetch_incoming_phone_number(configuration: &configuration::Configuration, params: FetchIncomingPhoneNumberParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodIncomingPhoneNumber, Error<FetchIncomingPhoneNumberError>> {
    let local_var_configuration = configuration;
...
pub async fn update_incoming_phone_number(configuration: &configuration::Configuration, params: UpdateIncomingPhoneNumberParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodIncomingPhoneNumber, Error<UpdateIncomingPhoneNumberError>> {
    let local_var_configuration = configuration;
