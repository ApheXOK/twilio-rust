...
pub async fn fetch_authorized_connect_app(configuration: &configuration::Configuration, params: FetchAuthorizedConnectAppParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodAuthorizedConnectApp, Error<FetchAuthorizedConnectAppError>> {
