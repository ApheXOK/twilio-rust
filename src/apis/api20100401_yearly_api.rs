...
/// 
pub async fn list_usage_record_yearly(configuration: &configuration::Configuration, params: ListUsageRecordYearlyParams) -> Result<models::ListUsageRecordYearlyResponse, Error<ListUsageRecordYearlyError>> {
