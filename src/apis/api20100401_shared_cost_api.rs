...
/// 
pub async fn list_available_phone_number_shared_cost(configuration: &configuration::Configuration, params: ListAvailablePhoneNumberSharedCostParams) -> Result<models::ListAvailablePhoneNumberSharedCostResponse, Error<ListAvailablePhoneNumberSharedCostError>> {
