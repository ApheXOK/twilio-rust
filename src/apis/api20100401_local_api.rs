...
/// 
pub async fn create_incoming_phone_number_local(configuration: &configuration::Configuration, params: CreateIncomingPhoneNumberLocalParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodIncomingPhoneNumberPeriodIncomingPhoneNumberLocal, Error<CreateIncomingPhoneNumberLocalError>> {
...
/// 
pub async fn list_available_phone_number_local(configuration: &configuration::Configuration, params: ListAvailablePhoneNumberLocalParams) -> Result<models::ListAvailablePhoneNumberLocalResponse, Error<ListAvailablePhoneNumberLocalError>> {
    let local_var_configuration = configuration;
