...
/// 
pub async fn list_usage_record_today(configuration: &configuration::Configuration, params: ListUsageRecordTodayParams) -> Result<models::ListUsageRecordTodayResponse, Error<ListUsageRecordTodayError>> {
