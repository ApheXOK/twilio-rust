...
/// Create a Siprec
pub async fn create_siprec(configuration: &configuration::Configuration, params: CreateSiprecParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodCallPeriodSiprec, Error<CreateSiprecError>> {
...
pub async fn update_siprec(configuration: &configuration::Configuration, params: UpdateSiprecParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodCallPeriodSiprec, Error<UpdateSiprecError>> {
    let local_var_configuration = configuration;
