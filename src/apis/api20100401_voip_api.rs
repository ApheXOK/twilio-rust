...
/// 
pub async fn list_available_phone_number_voip(configuration: &configuration::Configuration, params: ListAvailablePhoneNumberVoipParams) -> Result<models::ListAvailablePhoneNumberVoipResponse, Error<ListAvailablePhoneNumberVoipError>> {
