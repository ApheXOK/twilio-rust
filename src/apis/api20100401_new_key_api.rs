...
/// 
pub async fn create_new_key(configuration: &configuration::Configuration, params: CreateNewKeyParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodNewKey, Error<CreateNewKeyError>> {
