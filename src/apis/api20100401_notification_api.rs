...
/// 
pub async fn fetch_call_notification(configuration: &configuration::Configuration, params: FetchCallNotificationParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodCallPeriodCallNotificationInstance, Error<FetchCallNotificationError>> {
...
pub async fn fetch_notification(configuration: &configuration::Configuration, params: FetchNotificationParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodNotificationInstance, Error<FetchNotificationError>> {
    let local_var_configuration = configuration;
...
pub async fn list_notification(configuration: &configuration::Configuration, params: ListNotificationParams) -> Result<models::ListNotificationResponse, Error<ListNotificationError>> {
    let local_var_configuration = configuration;
