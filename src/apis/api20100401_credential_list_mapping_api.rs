...
pub async fn create_sip_credential_list_mapping(configuration: &configuration::Configuration, params: CreateSipCredentialListMappingParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipCredentialListMapping, Error<CreateSipCredentialListMappingError>> {
...
pub async fn fetch_sip_credential_list_mapping(configuration: &configuration::Configuration, params: FetchSipCredentialListMappingParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipCredentialListMapping, Error<FetchSipCredentialListMappingError>> {
    let local_var_configuration = configuration;
