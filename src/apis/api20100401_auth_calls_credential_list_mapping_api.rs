...
pub async fn create_sip_auth_calls_credential_list_mapping(configuration: &configuration::Configuration, params: CreateSipAuthCallsCredentialListMappingParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipAuthPeriodSipAuthCallsPeriodSipAuthCallsCredentialListMapping, Error<CreateSipAuthCallsCredentialListMappingError>> {
...
pub async fn fetch_sip_auth_calls_credential_list_mapping(configuration: &configuration::Configuration, params: FetchSipAuthCallsCredentialListMappingParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipAuthPeriodSipAuthCallsPeriodSipAuthCallsCredentialListMapping, Error<FetchSipAuthCallsCredentialListMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn list_sip_auth_calls_credential_list_mapping(configuration: &configuration::Configuration, params: ListSipAuthCallsCredentialListMappingParams) -> Result<models::ListSipAuthCallsCredentialListMappingResponse, Error<ListSipAuthCallsCredentialListMappingError>> {
    let local_var_configuration = configuration;
