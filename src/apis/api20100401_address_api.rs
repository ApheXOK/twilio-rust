...
/// 
pub async fn create_address(configuration: &configuration::Configuration, params: CreateAddressParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodAddress, Error<CreateAddressError>> {
...
/// 
pub async fn fetch_address(configuration: &configuration::Configuration, params: FetchAddressParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodAddress, Error<FetchAddressError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn update_address(configuration: &configuration::Configuration, params: UpdateAddressParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodAddress, Error<UpdateAddressError>> {
    let local_var_configuration = configuration;
