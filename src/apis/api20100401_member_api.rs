...
pub async fn fetch_member(configuration: &configuration::Configuration, params: FetchMemberParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodQueuePeriodMember, Error<FetchMemberError>> {
...
pub async fn update_member(configuration: &configuration::Configuration, params: UpdateMemberParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodQueuePeriodMember, Error<UpdateMemberError>> {
    let local_var_configuration = configuration;
