...
/// 
pub async fn fetch_signing_key(configuration: &configuration::Configuration, params: FetchSigningKeyParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodSigningKey, Error<FetchSigningKeyError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn update_signing_key(configuration: &configuration::Configuration, params: UpdateSigningKeyParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodSigningKey, Error<UpdateSigningKeyError>> {
    let local_var_configuration = configuration;
