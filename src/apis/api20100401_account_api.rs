...
pub async fn create_account(configuration: &configuration::Configuration, params: CreateAccountParams) -> Result<models::ApiPeriodV2010PeriodAccount, Error<CreateAccountError>> {
...
pub async fn fetch_account(configuration: &configuration::Configuration, params: FetchAccountParams) -> Result<models::ApiPeriodV2010PeriodAccount, Error<FetchAccountError>> {
    let local_var_configuration = configuration;
...
pub async fn update_account(configuration: &configuration::Configuration, params: UpdateAccountParams) -> Result<models::ApiPeriodV2010PeriodAccount, Error<UpdateAccountError>> {
    let local_var_configuration = configuration;
