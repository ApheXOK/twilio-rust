...
/// 
pub async fn list_usage_record_last_month(configuration: &configuration::Configuration, params: ListUsageRecordLastMonthParams) -> Result<models::ListUsageRecordLastMonthResponse, Error<ListUsageRecordLastMonthError>> {
