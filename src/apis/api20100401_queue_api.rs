...
/// Create a queue
pub async fn create_queue(configuration: &configuration::Configuration, params: CreateQueueParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodQueue, Error<CreateQueueError>> {
...
pub async fn fetch_queue(configuration: &configuration::Configuration, params: FetchQueueParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodQueue, Error<FetchQueueError>> {
    let local_var_configuration = configuration;
...
pub async fn update_queue(configuration: &configuration::Configuration, params: UpdateQueueParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodQueue, Error<UpdateQueueError>> {
    let local_var_configuration = configuration;
