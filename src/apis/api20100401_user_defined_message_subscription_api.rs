...
pub async fn create_user_defined_message_subscription(configuration: &configuration::Configuration, params: CreateUserDefinedMessageSubscriptionParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodCallPeriodUserDefinedMessageSubscription, Error<CreateUserDefinedMessageSubscriptionError>> {
