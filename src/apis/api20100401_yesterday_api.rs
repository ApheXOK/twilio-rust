...
/// 
pub async fn list_usage_record_yesterday(configuration: &configuration::Configuration, params: ListUsageRecordYesterdayParams) -> Result<models::ListUsageRecordYesterdayResponse, Error<ListUsageRecordYesterdayError>> {
