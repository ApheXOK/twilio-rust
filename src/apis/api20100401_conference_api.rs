...
pub async fn fetch_conference(configuration: &configuration::Configuration, params: FetchConferenceParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodConference, Error<FetchConferenceError>> {
...
/// 
pub async fn update_conference(configuration: &configuration::Configuration, params: UpdateConferenceParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodConference, Error<UpdateConferenceError>> {
    let local_var_configuration = configuration;
