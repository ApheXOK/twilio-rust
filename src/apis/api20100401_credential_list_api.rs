...
pub async fn create_sip_credential_list(configuration: &configuration::Configuration, params: CreateSipCredentialListParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipCredentialList, Error<CreateSipCredentialListError>> {
...
pub async fn fetch_sip_credential_list(configuration: &configuration::Configuration, params: FetchSipCredentialListParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipCredentialList, Error<FetchSipCredentialListError>> {
    let local_var_configuration = configuration;
...
pub async fn update_sip_credential_list(configuration: &configuration::Configuration, params: UpdateSipCredentialListParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipCredentialList, Error<UpdateSipCredentialListError>> {
    let local_var_configuration = configuration;
