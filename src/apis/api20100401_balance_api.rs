...
pub async fn fetch_balance(configuration: &configuration::Configuration, params: FetchBalanceParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodBalance, Error<FetchBalanceError>> {
