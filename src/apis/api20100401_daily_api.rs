...
/// 
pub async fn list_usage_record_daily(configuration: &configuration::Configuration, params: ListUsageRecordDailyParams) -> Result<models::ListUsageRecordDailyResponse, Error<ListUsageRecordDailyError>> {
