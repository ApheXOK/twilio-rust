...
/// 
pub async fn list_usage_record_this_month(configuration: &configuration::Configuration, params: ListUsageRecordThisMonthParams) -> Result<models::ListUsageRecordThisMonthResponse, Error<ListUsageRecordThisMonthError>> {
