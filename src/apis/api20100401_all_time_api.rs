...
/// 
pub async fn list_usage_record_all_time(configuration: &configuration::Configuration, params: ListUsageRecordAllTimeParams) -> Result<models::ListUsageRecordAllTimeResponse, Error<ListUsageRecordAllTimeError>> {
