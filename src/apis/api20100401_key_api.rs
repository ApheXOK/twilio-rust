...
/// 
pub async fn fetch_key(configuration: &configuration::Configuration, params: FetchKeyParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodKey, Error<FetchKeyError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn update_key(configuration: &configuration::Configuration, params: UpdateKeyParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodKey, Error<UpdateKeyError>> {
    let local_var_configuration = configuration;
