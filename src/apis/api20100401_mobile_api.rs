...
/// 
pub async fn create_incoming_phone_number_mobile(configuration: &configuration::Configuration, params: CreateIncomingPhoneNumberMobileParams) -> Result<models::ApiPeriodV2010PeriodAccountPeriodIncomingPhoneNumberPeriodIncomingPhoneNumberMobile, Error<CreateIncomingPhoneNumberMobileError>> {
...
/// 
pub async fn list_available_phone_number_mobile(configuration: &configuration::Configuration, params: ListAvailablePhoneNumberMobileParams) -> Result<models::ListAvailablePhoneNumberMobileResponse, Error<ListAvailablePhoneNumberMobileError>> {
    let local_var_configuration = configuration;
